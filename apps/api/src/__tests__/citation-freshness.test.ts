...
import { FreshnessInfo } from '@cw-rag-core/shared';
    ...
    it('should extract citations with freshness information', () => {
      ...
      const documents: HybridSearchResult[] = [
        createMockDocument(
          ...
          '2023-06-13T12:00:00.000Z', // Recent date
        ...
        createMockDocument(
          'doc2',
          'Older document content',
          '2023-01-15T12:00:00.000Z', // Older date
  ...
  describe('Enhanced citation service with freshness stats', () => {
    it('should provide enhanced citation stats including freshness', () => {
      ...
      const documents: HybridSearchResult[] = [
        createMockDocument(
          'doc1',
          'Fresh document with sufficient content for citation',
          '2023-06-13T12:00:00.000Z',
          undefined,
          'doc1',
          'https://example.com/doc1',
        ...
        createMockDocument(
          'doc2',
          'Recent document with sufficient content for citation',
        ...
        createMockDocument(
          'doc3',
          'Stale document with sufficient content for citation purposes',
          '2022-01-15T12:00:00.000Z',
          undefined,
          'doc3'
        )
    ...
    it('should filter short documents and include freshness for remaining', () => {
      ...
      const documents: HybridSearchResult[] = [
        ...
        createMockDocument(
          'doc2',
          'This is a longer document with sufficient content for citation',
          '2023-06-13T12:00:00.000Z'
        )
      ];
  ...
  describe('citation deduplication with freshness', () => {
    it('should preserve freshness information during deduplication', () => {
      ...
      const documents: HybridSearchResult[] = [
        ...
        createMockDocument(
          'doc2',
          'Second version of same document',
  ...
  describe('performance', () => {
    it('should handle large numbers of citations efficiently', () => {
      ...
      const documents: HybridSearchResult[] = Array.from({ length: 100 }, (_, i) =>
        createMockDocument(
          `doc${i}`,
          `Document ${i} with sufficient content for citation purposes`,
