    ...
    describe('OOD detection accuracy', () => {
        it('should correctly identify all OOD queries as non-answerable', () => {
            ...
            for (const testCase of oodTestCases) {
                ...
                const evaluation = guardrailService.evaluateAnswerability(testCase.query, simulatedResults, userContext);
                const result = {
                    testCase,
            ...
            const failedCases = results.filter(r => r.isAnswerable && r.testCase.expectedResponse === 'IDK');
