import { SimpleGuardrailService } from '../services/guardrail.js';
describe('Ask Endpoint Guardrail Integration', () => {
    ...
    describe('end-to-end guardrail evaluation', () => {
        it('should allow high-confidence queries', () => {
            ...
            const evaluation = service.evaluateAnswerability('What is the main topic?', searchResults, mockUserContext);
        ...
        it('should block low-confidence queries with IDK response', () => {
            ...
            const evaluation = service.evaluateAnswerability('What is the specific technical detail?', searchResults, mockUserContext);
        ...
        it('should block queries with no results', () => {
            const evaluation = service.evaluateAnswerability('Query with no results', [], mockUserContext);
            expect(evaluation.isAnswerable).toBe(false);
        ...
        it('should block queries with insufficient result count', () => {
            ...
            const evaluation = service.evaluateAnswerability('Query requiring multiple sources', searchResults, defaultUserContext);
            expect(evaluation.isAnswerable).toBe(false);
    ...
    describe('tenant-specific configurations', () => {
        it('should apply strict thresholds for enterprise tenant', () => {
            ...
            const evaluation = service.evaluateAnswerability('Enterprise query', searchResults, enterpriseUserContext);
        ...
        it('should apply permissive thresholds for dev tenant', () => {
            ...
            const evaluation = service.evaluateAnswerability('Development query', searchResults, devUserContext);
        ...
        it('should allow configuration updates', () => {
            ...
            const evaluation = service.evaluateAnswerability('Custom config test', searchResults, customUserContext);
        ...
        it('should bypass guardrail when disabled', () => {
            ...
            const evaluation = service.evaluateAnswerability('Query with disabled guardrail', searchResults, disabledUserContext);
    ...
    describe('real-world scenarios', () => {
        ...
        it('should handle queries typical of out-of-domain dataset', () => {
            ...
            const evaluation = service.evaluateAnswerability('What is the weather like today?', irrelevantResults, mockUserContext);
            expect(evaluation.isAnswerable).toBe(false);
        ...
        it('should handle empty content gracefully', () => {
            ...
            const evaluation = service.evaluateAnswerability('Query with empty content', resultsWithEmptyContent, mockUserContext);
