    ...
    fastify.post('/ask', {
        ...
        handler: async (request, reply) => {
            ...
            try {
                ...
                'pipeline', error.message, request.ip, request.ip // useAgent parameter
                );
                ...
                if (error.message.includes('service unavailable') || error.message.includes('connection')) {
