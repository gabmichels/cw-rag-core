...
export declare function searchDocuments(qdrantClient: QdrantClient, collectionName: string, request: RetrievalRequest, userContext: UserContext, vector?: number[]): Promise<PointStruct[]>;
/**
 * Legacy compatibility function - maintains backward compatibility
 * @deprecated Use searchDocuments with UserContext instead
 */
export declare function searchDocumentsLegacy(qdrantClient: QdrantClient, collectionName: string, request: RetrievalRequest, userTenants: string[], userAcl: string[]): Promise<PointStruct[]>;
export declare function keywordSearchDocuments(qdrantClient: QdrantClient, collectionName: string, query: string, limit: number, userContext: UserContext): Promise<PointStruct[]>;
/**
 * Legacy compatibility function for keyword search
 * @deprecated Use keywordSearchDocuments with UserContext instead
 */
export declare function keywordSearchDocumentsLegacy(qdrantClient: QdrantClient, collectionName: string, query: string, limit: number, userTenants: string[], userAcl: string[]): Promise<PointStruct[]>;
/**
 ...
 */
export declare function securityTestSearch(qdrantClient: QdrantClient, collectionName: string, userContext: UserContext, vector: number[], limit?: number): Promise<PointStruct[]>;
/**
 ...
 */
export declare function batchSearchDocuments(qdrantClient: QdrantClient, collectionName: string, userContext: UserContext, vectors: number[][], limit?: number): Promise<PointStruct[][]>;
/**
 ...
 */
export declare function optimizedSearchDocuments(qdrantClient: QdrantClient, collectionName: string, userContext: UserContext, vector: number[], limit?: number, exactSearch?: boolean): Promise<PointStruct[]>;
