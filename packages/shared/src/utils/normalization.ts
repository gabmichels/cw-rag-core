 ...
 * ```
 */
export function canonicalizeForHash(content: string | Block[]): string {
 ...
 * ```
 */
export function computeSha256(input: Buffer | string): string {
 ...
 */
function containsSpanishIndicators(text: string): boolean {
 ...
 */
function containsFrenchIndicators(text: string): boolean {
 ...
 */
function containsItalianIndicators(text: string): boolean {
 ...
 */
function containsPortugueseIndicators(text: string): boolean {
 ...
 */
function hasLanguageIndicators(text: string, words: string[], specialChars: RegExp): boolean {
